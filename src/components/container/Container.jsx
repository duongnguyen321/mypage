  ...
  function Projects(context) {
    return (
       <div className="projects">
                ...
                <div className="project_item">
                  <p className="body_16_medium project_time">
                    {context.projects.ocopGreen.time}
                  </p>
                  <p className="body_18_medium project_name">
                    {context.projects.ocopGreen.name}
                  </p>
                  <a
                    target="_blank"
                    rel="noreferrer"
                    className="body_14_regular project_link"
                    href={context.projects.ocopGreen.link}
                  >
                    Link : {context.projects.ocopGreen.name}
                  </a>
                  <a
                    target="_blank"
                    rel="noreferrer"
                    className="body_14_regular project_link"
                    href={context.projects.ocopGreen.code}
                  >
                    Code : {context.projects.ocopGreen.name}
                  </a>
                  <p className="body_14_regular project_info">
                    {context.projects.ocopGreen.more}
                  </p>
                </div>
                <div className="project_item">
                  <p className="body_18_medium project_name">
